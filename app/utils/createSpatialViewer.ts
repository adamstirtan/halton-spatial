...
export const createSpatialViewer = ({
  ...
  // Future PLY and Gaussian Splat loaders should replace the placeholder nodes below
  // while keeping this renderer, camera, controls, resize, and disposal lifecycle intact.
